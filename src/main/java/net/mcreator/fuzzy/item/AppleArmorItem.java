...
public abstract class AppleArmorItem extends ArmorItem {
	public AppleArmorItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Helmet extends AppleArmorItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "fuzzy:textures/models/armor/apple_layer_1.png";
		}
	}
	...
	public static class Leggings extends AppleArmorItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "fuzzy:textures/models/armor/apple_layer_2.png";
		}
	}
