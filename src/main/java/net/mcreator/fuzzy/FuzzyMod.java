...
import net.mcreator.fuzzy.init.FuzzyModSounds;
...
@Mod("fuzzy")
public class FuzzyMod {
	public static final Logger LOGGER = LogManager.getLogger(FuzzyMod.class);
	public static final String MODID = "fuzzy";
	...
	public FuzzyMod() {
		...
		FuzzyModSounds.REGISTRY.register(bus);
